...
class RealDataPlatformV2(MemorySafeExtendedHorizonPlatform):
    ...
    def train_if_due(self, force: bool = False) -> bool:
        ...
        enough_new_rows = final_count >= self._last_envelope_training_final_rows + retrain_rows
    ...
    def run_cycle(self, force_train: bool = False) -> dict[str, Any]:
        ...
        return {
            ...
            "first_touch_available_horizons": sorted(self._available_horizons(self._bundle)),
            "envelope_available_horizons": sorted(self._available_horizons(self.envelope.bundle)),
